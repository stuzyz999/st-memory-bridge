...
- sillytavern LLM API配置（模型拉去、多配置持久化）、正文正则清洗、上下文读取（历史正文、世界书、user设定）、内容选择、半自动摄入（楼层设置）、多tab交互、提示词系统等可复用参考项目的方案，一律借鉴，只搭建UI框架，最快落地。
...
- chrome devtools mcp,调试地址：<http://127.0.0.1:8008/>
-
